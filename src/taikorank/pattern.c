...
static osux_yaml * yw_ptr;
static GHashTable * ht_cst_ptr;
...
static struct counter * tro_pattern_new_counter(
    const struct tr_object * o, int i);
...
static void pattern_global_init(GHashTable * ht_cst)
{
