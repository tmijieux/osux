...
#
# CMAKE_GTS_C_FLAGS  = Unix compiler flags for GTS, essentially "`gts-config --cflags`"
#
  ...
  IF(UNIX)
    ...
    IF (GTS_CONFIG)
      ...
      EXEC_PROGRAM(${GTS_CONFIG}
        ARGS --cflags
        OUTPUT_VARIABLE  GTS_C_FLAGS )
       #SET(GTS_C_FLAGS "`${GTS_CONFIG} --cflags`")
      SET(CMAKE_GTS_C_FLAGS ${GTS_C_FLAGS})
      #      MESSAGE("DBG ${GTS_C_FLAGS}")
    ...
    ELSE(GTS_CONFIG)
      ...
      PKGCONFIG(gts GTS_INCLUDE_DIR GTS_LINK_DIRECTORIES GTS_LIBRARIES GTS_C_FLAGS)
      IF(GTS_INCLUDE_DIR)
	MARK_AS_ADVANCED(
          GTS_C_FLAGS
          GTS_INCLUDE_DIR
...
IF(GTS_LIBRARIES)
  IF(GTS_INCLUDE_DIR OR GTS_C_FLAGS)

    SET(GTS_FOUND 1)

  ENDIF(GTS_INCLUDE_DIR OR GTS_C_FLAGS)
ENDIF(GTS_LIBRARIES)
